      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <div className="flex items-center gap-3 mt-2">
            <span className="stat-number text-2xl" style={{ color: 'var(--skin-primary)' }}>{files.length}</span>
            <span className="text-xs tracking-widest uppercase text-[var(--skin-text-secondary)] font-bold">个文件</span>
          </div>
        </div>
